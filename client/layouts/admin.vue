...
useHead({
  ...
  bodyAttrs: {
    class: 'h-full bg-base-200 dark:bg-base-300',
  },
})
            ...
            <div class="flex flex-1 md:gap-1 lg:gap-2">
                ...
                ><label
                  ...
                  ><svg
                    ...
                    <path
                      ...
                      stroke-width="2"
                      d="M4 6h16M4 12h16M4 18h16"></path></svg></label
              ></span>
              <div class="flex items-center gap-2 lg:hidden">
                <a
                  ...
                  ><div
                    class="font-title flex-row-reverse text-primary inline-flex text-lg transition-all duration-200 md:text-3xl">
                    <span class="uppercase text-primary">G</span>
                    <span class="lowercase text-base-content">MODERN</span>
                  </div></a
                >
              </div>
            </div>
                      ...
                      ><div
                        ...
                        <div class="flex gap-2 p-3">
                          <svg
                            ...
                            viewBox="0 0 512 512">
                            <path
                              d="M96,208H48a16,16,0,0,1,0-32H96a16,16,0,0,1,0,32Z"></path>
                            <line
                              x1="90.25"
                              y1="90.25"
                              x2="124.19"
                            ...
                            <path
                              d="M192,112a16,16,0,0,1-16-16V48a16,16,0,0,1,32,0V96A16,16,0,0,1,192,112Z"></path>
                            <line
                              x1="293.89"
                              y1="90.25"
                              x2="259.95"
                  ...
                  <ul class="menu menu-compact gap-1 p-3" tabindex="0">
                    ...
                    <li>
                      <button class="flex">
                        ...
                        <span class="flex flex-1 justify-between">日本語 </span>
                      </button>
                    </li>
                    <li>
                      <button class="flex">
                        ...
                        <span class="flex flex-1 justify-between">한국어 </span>
                      </button>
                    </li>
                    <li>
                      <button class="flex">
      ...
      <div
        ...
        <aside class="bg-base-200 w-80">
          <div
            ...
            <a
              ...
              <div
                ...
                <span class="text-base-content lowercase">modern</span>
              </div></a
            >
          </div>
          <div class="h-4"></div>
          <ul class="menu menu-compact flex flex-col p-0 px-4">
            <li>
              <nuxt-link href="/admin" id="" class="flex gap-4"
            ...
            <li></li>
            <li class="menu-title"><span>کاربران</span></li>
            ...
            <li>
              <nuxt-link
                ...
                ></span>
                <span class="flex-1">لیست کاربران</span>
              </nuxt-link>
            </li>
          </ul>
          <div
