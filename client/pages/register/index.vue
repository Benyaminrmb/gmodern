...
<template>
 ...
 واسه ثبت نام فقط اسمو ایمیلو رمزت نیازه.
           <span class="text-sm mt-3 flex flex-wrap justify-center"> (میدونم خیلی هم فرقی نداره با بقیه😁)</span>
        </h2>
